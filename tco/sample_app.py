...
CONFIG = {
    'client_id': '6aeb81a251d948e181cd794232c65f8a',
    'client_secret': 'b138bea14ebb4fd4936fc08151c72529',
...
# def getUserId(access_token, data = {}):
# 	url = 'https://api.instagram.com/v1/users/{}/?access_token='
# 	data['access_token'] = requests.session['access_token']
# 	callingUrl = url.format('self')
# 	response = requests.get(searchurl, params = data)
